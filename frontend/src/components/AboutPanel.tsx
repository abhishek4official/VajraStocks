  ...
  return (
    <div className="flex-1 flex flex-col gap-6 p-6 overflow-y-auto max-h-full bg-bg-base">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-accent-primary font-bold uppercase tracking-widest mt-0.5">
                  NSE Quantitative Research &amp; Decision-Support — v{import.meta.env.VITE_APP_VERSION}
                </p>
              </div>
            </div>
            <a
      ...
      <div className="flex items-center justify-between text-[11px] text-slate-600 px-1 pb-2 flex-wrap gap-2 shrink-0">
        <span>VajraStocks v{import.meta.env.VITE_APP_VERSION} — local-first database, privacy-focused.</span>
